import { Flash, Global, Logout, LogoutCurve, Notification, Setting, Setting2, Star, UserEdit } from 'iconsax-react-native';
        ...
        <View style={{ marginTop: 10 }}>
          <View style={{ ...styles.imageContainer, paddingHorizontal: 20, marginBottom: 20 }}>
            ...
            <View style={{ marginLeft: 10 }}>
              <Text style={styles.profileName}>Muhamad Rafi Faddilani</Text>
              <View style={{ alignItems: 'center', flexDirection: 'row', }}>
                <Star color={'rgb(255, 125, 0)'} variant="Linear" size={24} />
                <Text style={{ ...styles.profileInfo, color: 'rgb(255, 125, 0)', fontWeight: 'bold', paddingLeft: 5, }}>Premium</Text>
              </View>
            </View>
          </View>
          ...
          <View style={{}}>
            <View style={{ paddingHorizontal: 20, marginBottom: 10 }}>
              <Text style={{ ...styles.profileInfo, color: 'black', fontWeight: 'bold', }}>Pengaturan Akun</Text>
            </View>
            <TouchableOpacity>
            <View style={{ flexDirection: 'row', paddingHorizontal: 24, marginBottom: 25, }}>
              <UserEdit color={'blue'} variant="Linear" size={24} />
            ...
            <TouchableOpacity>
            <View style={{ flexDirection: 'row', paddingHorizontal: 24, marginBottom: 25, }}>
              <Setting2 color={'blue'} variant="Linear" size={24} />
              <View style={{ flexDirection: 'column' }}>
            ...
            <TouchableOpacity>
            <View style={{ flexDirection: 'row', paddingHorizontal: 24, marginBottom: 25, }}>
              <Global color={'blue'} variant="Linear" size={24} />
              <View style={{ flexDirection: 'column' }}>
                <Text style={styles.profileSetting}>Pengaturan Bahasa</Text>
                <Text style={styles.profileSettingDesc}>Perbarui pengaturan bahasa</Text>
              </View>
            </View>
            </TouchableOpacity>
            <TouchableOpacity>
            <View style={{ flexDirection: 'row', paddingHorizontal: 24, marginBottom: 25, }}>
              <LogoutCurve color={'blue'} variant="Linear" size={24} />
              <View style={{ flexDirection: 'column' }}>
